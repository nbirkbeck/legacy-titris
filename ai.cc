	...
	switch(cur->titType)
	{
		...
		*/
		...
		case TT:
		{
			...
			while(j<(COLS-2))
			{
				if((surfOutline[j]==surfOutline[j+1])&&(surfOutline[j+1]==surfOutline[j+2]))
				{
					if(deepFU==-1)
						deepFU=j;
			...
			while(j<(COLS-1))
			{
				if((surfOutline[j]+1==surfOutline[j+1])&&(surfOutline[j]==surfOutline[j+2]))
				{
					if(deepFD==-1)
						deepFD=j+1;
		...
		case TNORML:
		{
			...
			while(j<(COLS-2))
			{
				if((surfOutline[j]-1==surfOutline[j+1])&&(surfOutline[j+1]==surfOutline[j+2]))
				{
					if(deepFD==-1)
						deepFD=j;
					else if(surfOutline[deepFD]<surfOutline[j])
		...
		case TREVL:
		{
			...
			while(j<(COLS-2))
			{
				if((surfOutline[j]==surfOutline[j+1])&&(surfOutline[j+1]==surfOutline[j+2]-1))
				{
					if(deepFD==-1)
						deepFD=j+2;
